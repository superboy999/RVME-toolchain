...
#define MASK_MATRIX (1U << 11)
#define MASK_MUL (1U << 12)
#define MASK_RVC (1U << 13)
#define MASK_RVE (1U << 14)
#define MASK_RVZFH (1U << 15)
#define MASK_VECTOR (1U << 16)
#define MASK_XTHEAD (1U << 17)
#define MASK_XTHEAD_C (1U << 18)
#define MASK_XTHEAD_E (1U << 19)
#define MASK_XTHEAD_SE (1U << 20)
#define MASK_XTHEAD_V (1U << 21)
#define MASK_ZPN (1U << 22)
#define MASK_ZPRVSFEXTRA (1U << 23)
#define MASK_ZPSFOPERAND (1U << 24)
...
#define TARGET_MATRIX ((target_flags & MASK_MATRIX) != 0)
